...

{
  ...
  home.file.".config/joshuto" = {
    source = ../files/joshuto;
    recursive = true;
  };
  ...
  programs.joshuto = {
    ...
    settings = builtins.fromTOML ''
      ...
      preview_script = "~/.config/joshuto/preview_file" # make sure it's marked as executable
    ...
    # maybe leave only those that are not default
